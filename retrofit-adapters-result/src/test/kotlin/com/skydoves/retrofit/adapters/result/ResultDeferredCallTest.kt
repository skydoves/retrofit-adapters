...
internal class ResultDeferredCallTest : ApiMockServiceTest<PokemonDeferredService>() {
  ...
  fun initService() {
    ...
    service =
      createService(PokemonDeferredService::class.java, ResultCallAdapterFactory.create(testScope))
  }
